...
namespace IMDBfetch
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.fetchButton.Click += new System.EventHandler(this.FetchButtonClick);
			// 
			// browseButton
			// 
			...
			this.rawRadioButton.CheckedChanged += new System.EventHandler(this.RawRadioButtonCheckedChanged);
			// 
			...
			this.descCheckBox.CheckedChanged += new System.EventHandler(this.DescCheckBoxCheckedChanged);
			// 
			// tableLayoutPanel3
			// 
			...
			this.imagePictureBox.MouseMove += new System.Windows.Forms.MouseEventHandler(this.ImagePictureBoxMouseMove);
			// 
			// infoLabel
			// 
			...
			this.aPIKeyToolStripMenuItem.Click += new System.EventHandler(this.APIKeyToolStripMenuItemClick);
			// 
